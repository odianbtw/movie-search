...
import com.odian.moviesearch.dao.postgres.mapper.LanguageEntityMapperImpl;
...
public class LanguageEntityMapperTest {
    ...
    private static final LanguageEntityMapper subject = new LanguageEntityMapperImpl();
